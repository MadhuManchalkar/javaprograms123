...
public class CreateCustomer {
	...
	public static void main(String[] args) {
		Createcustomertest1.show();
		Createcustomertest1.navigate();
		Createcustomertest1.logic();
		Createcustomertest1.minimizeFlyOutWindow();
		
	     Createcustomertest1.modifyusrer();
	Createcustomertest1.deletusrer();
		Createcustomertest1.logout();
	}
